...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t bg-[hsl(var(--muted)/0.5)] font-medium [&>tr]:last:border-b-0", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-start align-middle font-medium text-[hsl(var(--muted-foreground))] [&:has([role=checkbox])]:pe-0",
      className
    )}
    {...props}
  />
